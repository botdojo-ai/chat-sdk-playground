...
export default function FlowChat(props: FlowChatProps) {
  ...
  const loadSessionHistory = async (sessionId: string) => {
    ...
    try {
      ...
      // Get flowId from environment based on flowType
      const flowId = flowType === 'model-context' 
        ? process.env.NEXT_PUBLIC_BOTDOJO_MODEL_CONTEXT_FLOW_ID
        : process.env.NEXT_PUBLIC_BOTDOJO_SIMPLE_TEST_FLOW_ID;
