...
export default function AgentUIAnimation({ maxWidth = '950px', showProgress = true }: AgentUIAnimationProps) {
  ...
  const enhancedDesc = "Handcrafted oak chair with ergonomic design and natural finish.";
  ...
  const originalDesc = "Basic wooden chair. Good for sitting.";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <text x="135" y="47" fontSize="11" fill="#64748b">mystore.com/admin/products/edit</text>
        
        {/* Lock icon */}
        <circle cx="130" cy="42" r="4" fill="none" stroke="#22c55e" strokeWidth="1.5" />
        <rect x="127" y="42" width="6" height="4" rx="1" fill="#22c55e" />
        ...
        <g clipPath="url(#browserClip)">
          ...
          <text x="224" y="120" fontSize="11" fill="#64748b">SKU: CHAIR-OAK-001</text>
          
          {/* Product form */}
          <g>
            {/* Product image placeholder */}
            <rect x="224" y="140" width="120" height="120" rx="8" fill="#f1f5f9" stroke={borderColor} strokeWidth="1" />
            <text x="284" y="195" fontSize="10" fill="#94a3b8" textAnchor="middle">Product</text>
            <text x="284" y="210" fontSize="10" fill="#94a3b8" textAnchor="middle">Image</text>
            {/* Simple chair icon */}
            <rect x="264" y="165" width="40" height="8" rx="2" fill="#cbd5e1" />
            <rect x="268" y="173" width="4" height="20" fill="#cbd5e1" />
            <rect x="296" y="173" width="4" height="20" fill="#cbd5e1" />
            ...
            <text x="372" y="185" fontSize="13" fill="#0f172a">Oak Dining Chair</text>
            ...
            <text x="372" y="248" fontSize="13" fill="#0f172a">$149.99</text>
            ...
            <text x="512" y="248" fontSize="13" fill="#0f172a">Furniture</text>
          </g>
          ...
          <g>
            ...
            <text x="236" y="350" fontSize="12" fill="#0f172a">
            ...
            {showModified && (
              <g>
                <rect x="530" y="418" width="105" height="20" rx="10" fill="#f0fdf4" stroke={successColor} strokeWidth="1" />
                <text x="544" y="432" fontSize="9" fill={successColor} fontWeight="600">✓ AI Enhanced</text>
              </g>
            )}
          </g>
          ...
          >
            ...
            {/* Panel header */}
            <rect x="660" y="64" width="220" height="44" fill="url(#agentGrad)" rx="0" />
            <text x="685" y="92" fontSize="13" fill="white" fontWeight="600">Agent</text>
            
            {/* Clear and X buttons */}
            <text x="800" y="90" fontSize="10" fill="rgba(255,255,255,0.8)">↻ Clear</text>
            <text x="855" y="92" fontSize="14" fill="rgba(255,255,255,0.9)">×</text>
            
            {/* Chat area */}
            <rect x="660" y="108" width="220" height="324" fill="#fafafa" />
            
            {/* Pre-filled prompt bubble */}
            {step >= 2 && (
              <g>
                <rect 
                  x="700" 
                  ...
                  fill="#e0e7ff"
                />
                <text x="715" y="137" fontSize="11" fill="#0f172a">Enhance product description</text>
              </g>
            )}
            ...
            {step === 2 && (
              <g>
                ...
                {/* Widget header */}
                <rect x="672" y="160" width="196" height="32" rx="10" fill="rgba(99, 102, 241, 0.1)" />
                <rect x="672" y="182" width="196" height="10" fill="rgba(99, 102, 241, 0.1)" />
                
                {/* Sparkle and title */}
                <text x="684" y="182" fontSize="10" fill={primaryColor}>✨</text>
                <text x="698" y="182" fontSize="10" fill={primaryColor} fontWeight="600">
                ...
                {(() => {
                  ...
                  return lines.map((line, i) => (
                    <text key={i} x="684" y={210 + i * 18} fontSize="11" fill="#0f172a">
                      {line}
            ...
            {showSideBySide && (
              <g>
                ...
                {/* Widget header */}
                <rect x="672" y="160" width="196" height="28" rx="10" fill={step >= 4 ? "rgba(16, 185, 129, 0.1)" : "rgba(99, 102, 241, 0.1)"} />
                <rect x="672" y="178" width="196" height="10" fill={step >= 4 ? "rgba(16, 185, 129, 0.1)" : "rgba(99, 102, 241, 0.1)"} />
                
                <text x="684" y="180" fontSize="9" fill={step >= 4 ? successColor : primaryColor} fontWeight="600">
                  {step >= 4 ? "✓ Applied" : "Choose a variation"}
                </text>
                
                {/* Thumbs up/down */}
                <text x="838" y="178" fontSize="11" fill="#94a3b8">👎</text>
                <text x="854" y="178" fontSize="11" fill="#94a3b8">👍</text>
                ...
                <rect 
                  ...
                  strokeWidth="1"
                />
                <text x="688" y="215" fontSize="8" fill="#64748b" fontWeight="600">Original</text>
                <text x="688" y="232" fontSize="7" fill="#475569">Basic wooden</text>
                <text x="688" y="244" fontSize="7" fill="#475569">chair. Good</text>
                <text x="688" y="256" fontSize="7" fill="#475569">for sitting.</text>
                ...
                <rect 
                  ...
                  strokeWidth="2"
                />
                <text x="780" y="215" fontSize="8" fill={primaryColor} fontWeight="600">Modified</text>
                <text x="780" y="232" fontSize="7" fill="#475569">Handcrafted oak</text>
                <text x="780" y="244" fontSize="7" fill="#475569">chair with ergonomic</text>
                <text x="780" y="256" fontSize="7" fill="#475569">design and natural</text>
                <text x="780" y="268" fontSize="7" fill="#475569">finish.</text>
                
                {/* Selection checkmark on Modified */}
                <circle cx="850" cy="203" r="8" fill={primaryColor} />
                <path d="M846 203 L849 206 L854 200" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                
                {/* Status message */}
                {step >= 4 ? (
                  <g>
                    <rect x="680" y="296" width="180" height="28" rx="6" fill="#f0fdf4" />
                    <text x="770" y="315" fontSize="10" fill={successColor} textAnchor="middle" fontWeight="500">
                      ✓ Description updated
                    </text>
                  </g>
                ) : (
                  <g>
                    <rect x="680" y="296" width="180" height="28" rx="6" fill="rgba(99, 102, 241, 0.1)" />
                    <text x="770" y="315" fontSize="10" fill={primaryColor} textAnchor="middle" fontWeight="500">
            ...
            {/* Input area */}
            <rect x="660" y="432" width="220" height="48" fill="white" />
            <rect x="660" y="431" width="220" height="1" fill={borderColor} />
            <rect x="675" y="442" width="155" height="28" rx="14" fill="#f1f5f9" />
            <text x="690" y="461" fontSize="11" fill="#94a3b8">Ask anything...</text>
            
            {/* Send button */}
            <circle cx="850" cy="456" r="14" fill={primaryColor} />
            <path d="M845 456 L855 456 M852 452 L856 456 L852 460" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          </g>
      ...
      {showProgress && (
        <div style={{ marginTop: '20px', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '14px', color: '#64748b', fontWeight: 500 }}>
            ...
            {step === 2 && 'AI writes enhanced description...'}
            {step === 3 && 'Review Original vs Modified comparison'}
            {step === 4 && 'Description updated with AI enhancement'}
            {step === 5 && 'Product ready with improved copy'}
          </div>
        </div>
      )}
    </div>
