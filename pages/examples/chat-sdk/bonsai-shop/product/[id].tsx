  ...
  if (!product) {
    return (
      <div style={{ minHeight: '100vh', backgroundColor: '#0f172a', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: '16px' }}>
        ...
        <Link href="/examples/chat-sdk/bonsai-shop" style={{ color: '#10b981', textDecoration: 'none' }}>
          ← Back to Shop
        </Link>
      </div>
    );
    ...
    <BonsaiShopLayout>
      ...
      <main style={{ maxWidth: '1400px', margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div style={{ marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px' }}>
          <Link href="/examples/chat-sdk/bonsai-shop" style={{ color: '#94a3b8', textDecoration: 'none' }}>
            Shop
          </Link>
          <span style={{ color: '#64748b' }}>/</span>
          <Link href={`/examples/chat-sdk/bonsai-shop?category=${product.category}`} style={{ color: '#94a3b8', textDecoration: 'none', textTransform: 'capitalize' }}>
            ...
            <div style={{
              ...
              {relatedProducts.map(relatedProduct => (
                <Link
                  ...
                  href={`/examples/chat-sdk/bonsai-shop/product/${relatedProduct.id}`}
