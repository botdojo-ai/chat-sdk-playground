    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', position: 'relative', height: 'calc(100vh - 40px)', overflow: 'hidden' }}>
      ...
      <div style={{ 
        ...
        <p style={{ margin: '0 0 12px 0', fontSize: '14px', color: '#64748b', lineHeight: 1.6 }}>
          This example demonstrates how AI agents can edit documents using <strong>Frontend MCP tools</strong> and <strong>Chat Widgets</strong>. 
          The agent reads the current document content, suggests improvements with a visual diff view, and allows users to accept or reject changes. 
          It showcases bidirectional communication between the chat interface and the document editor.
        </p>
        <div style={{ marginTop: '16px' }}>
          <div style={{ fontSize: '13px', fontWeight: 600, color: '#475569', marginBottom: '8px' }}>Components Used:</div>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
            {['BotDojoChat', 'Frontend MCP Tools', 'MDXEditor', 'Chat Widgets (MCP Apps)', 'Diff Review UI'].map((component) => (
              <span
                key={component}
                style={{
                  padding: '4px 10px',
