    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', position: 'relative', height: 'calc(100vh - 40px)', overflow: 'hidden' }}>
      ...
      <div style={{ 
        ...
        <p style={{ margin: '0 0 12px 0', fontSize: '14px', color: '#64748b', lineHeight: 1.6 }}>
          This example demonstrates <strong>Chat Widgets (MCP Apps)</strong> - interactive UI components that render inside chat conversations. 
          It shows how widgets communicate with the host using JSON-RPC messages, handle tool streaming, persist state across interactions, 
        ...
        <div style={{ marginTop: '16px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
            {['BotDojoChat', 'MCP Apps (Chat Widgets)', 'JSON-RPC Communication', 'Tool Streaming', 'State Persistence'].map((component) => (
              <span
                key={component}
                style={{
                  padding: '4px 10px',
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: '16px', flex: 1, minHeight: '600px' }}>
        <div style={{
          background: '#ffffff',
          border: '1px solid #e2e8f0',
          borderRadius: '14px',
...
This example demonstrates tool streaming progress and state persistence in Chat Widgets.
