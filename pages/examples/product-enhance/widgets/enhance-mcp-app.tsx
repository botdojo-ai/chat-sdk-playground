        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <img src="https://playground.botdojo.com/images/products/product-2.png" alt="checkmark" width="10" height="10" />
        ...
        <div style={{ 
          ...
          <div 
            ...
            style={{ 
              flex: 1,
              padding: '12px',
              background: selectedVersion === 'modified' ? '#f0fdf4' : '#ffffff',
              borderRadius: '8px',
          ...
          >
            ...
            <div style={{ 
              fontSize: '10px', 
              fontWeight: 600, 
              color: selectedVersion === 'modified' ? '#10b981' : '#64748b', 
              marginBottom: '8px',
              textTransform: 'uppercase',
            }}>
              Modified
